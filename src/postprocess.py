...
def main():
    ...
    HAMON_config_file_path = '/home/villar/Programs/HAMON'
    HAMON_config_file_name = 'HAMON_Multi_config'
    EA_config_file_path = '/home/villar/Programs/HAMON'
    EA_config_file_name = 'EA_config'
